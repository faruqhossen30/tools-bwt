        ...
        <div class="row">
            ...
            <div class="col">
                <div class="input-group input-group-flat">
                    <input type="text" class="form-control" wire:model="link" required />
                ...
                <div class="form-group">
                    <button class="btn btn-info mx-auto d-block">
                        <span>
                            ...
                            <span wire:target="onYoutubeThumbnailDownloader">{{ __('Start') }}</span>
                        </span>
                    </button>
                </div>
            </div>
                    ...
                    @foreach ($data as $element)
                        <div class="tab-pane {{ ($loop->index == 0) ? 'active show' : '' }}" id="tabs-{{ $loop->index }}">
                            <div class="form-group text-center mx-auto mb-3">
                                <a class="btn btn-success download-image" href="{{ $element['url'] }}" download>
