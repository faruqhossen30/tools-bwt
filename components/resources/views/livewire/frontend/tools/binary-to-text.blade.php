<div>
      ...
      <form wire:submit.prevent="onBinaryToText">
        ...
        <div class="form-group mb-3">
            <textarea class="form-control" wire:model="binary" rows="10" placeholder="{{ __('Paste your binary here...') }}" required></textarea>
        </div>
        ...
        <div class="form-group mb-3">
            <button class="btn btn-info" wire:loading.attr="disabled">
              <span>
                ...
                <span wire:target="onBinaryToText">{{ __('Convert') }}</span>
              </span>
            </button>
