<div>
      ...
      <form wire:submit.prevent="onBase64Decode">
        ...
        <div class="form-group mb-3">
            <textarea class="form-control" wire:model="text" rows="10" placeholder="{{ __('Paste your code here...') }}" required></textarea>
        </div>
        ...
        <div class="form-group mb-3">
            <button class="btn btn-info">
              <span>
                ...
                <span wire:target="onBase64Decode">{{ __('Decode') }}</span>
              </span>
            </button>
        </div>
