<div>
      ...
      <form wire:submit.prevent="onPasswordGenerator">
        ...
        <div class="form-group mb-3">
            ...
            <select wire:model="password_length" class="form-control">
        ...
        <div class="form-group mb-3">
            <label class="form-check">
                <input class="form-check-input" type="checkbox" wire:model="uppercase" />
                <span class="form-check-label">{{ __('Include Uppercase Text') }}</span>
            </label>

            <label class="form-check">
                <input class="form-check-input" type="checkbox" wire:model="lowercase" />
                <span class="form-check-label">{{ __('Include Lowercase Text') }}</span>
            </label>

            <label class="form-check">
                <input class="form-check-input" type="checkbox" wire:model="numbers" />
                <span class="form-check-label">{{ __('Include Numbers') }}</span>
            </label>

            <label class="form-check">
                <input class="form-check-input" type="checkbox" wire:model="symbols" />
        ...
        <div class="form-group mb-3">
            <button class="btn btn-info mx-auto d-block">
              <span>
                ...
                <span wire:target="onPasswordGenerator">{{ __('Generate') }}</span>
              </span>
            </button>
        </div>
