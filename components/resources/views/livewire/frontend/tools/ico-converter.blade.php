      ...
      <form wire:submit.prevent="onIcoConverter">
        ...
        <div class="image-container">
          ...
          <div class="form-group my-3">
            ...
            <select class="form-control" wire:model="icon_size">
          ...
          <div class="form-group my-3">
              <button class="btn btn-info mx-auto d-block">
                <span>
                  ...
                  <span wire:target="onIcoConverter">{{ __('Convert') }}</span>
                </span>
              </button>
          </div>

        @if ( !empty($data) )  
            <div class="text-center" wire:loading.remove wire:target="onIcoConverter">
