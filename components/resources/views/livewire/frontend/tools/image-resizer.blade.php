<div>
                ...
                <fieldset class="form-fieldset d-flex flex-column bd-highlight shadow-sm flip_clock_image">
                    <div class="d-inline-flex">
                        ...
                        <div class="card card-body cursor-pointer">
                            ...
                            <select class="form-control ratio-toggles" name="aspectRatio">
        ...
        <div class="card my-3 shadow-sm">
                <div class="card-body">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-lg-4">
                            <div class="form-floating mb-3">
                              <select class="form-control" wire:model="image_format">
        ...
        <div class="text-center resize_image">
            <button class="btn btn-azure my-3" wire:loading.attr="disabled" data-method="getCroppedCanvas" data-option="{ &quot;width&quot;: {{ $imageWidthFinal }}, &quot;height&quot;: {{ $imageHeightFinal }} }">
              <span>
