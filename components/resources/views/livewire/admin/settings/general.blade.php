					...
					<div class="card-body">
							...
							<table class="table table table-vcenter card-table settings">
								...
								<tr>
									...
									<td class="w-75">
										<div class="form-check form-switch mb-0 ps-0">
											<input id="theme_mode" class="form-check-input ms-auto" type="checkbox" wire:model="theme_mode">
										</div>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="w-75">
										<div class="form-check form-switch mb-0 ps-0">
											<input id="dir_mode" class="form-check-input ms-auto" type="checkbox" wire:model="dir_mode">
										</div>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="align-middle">
										<div class="form-check form-switch mb-0 ps-0">
											<input id="adblock_detection" class="form-check-input ms-auto" type="checkbox" wire:model="adblock_detection">
										</div>
									</td>
								</tr>
								...
								<tr>
									<td class="align-middle"><label for="author-box-status" class="form-label mb-0">{{ __('Enable Search Box on the HomePage') }}</label></td>
									<td class="align-middle">
										<div class="form-check form-switch mb-0 ps-0">
											<input id="author-box-status" class="form-check-input ms-auto" type="checkbox" wire:model="search_box_status">
										</div>
									</td>
								</tr>
