		...
		<div class="card">
			...
			<div class="card-body">
				<table class="table table-vcenter card-table settings">
					...
					<tr>
						<td><label for="host" class="form-label">{{ __('Site Title') }}</label></td>
						<td>
							<input id="host" class="form-control ms-auto" type="text" wire:model="appname" placeholder="SumoWebTools">
							<small class="form-hint">{{ __('Your site title.') }}</small>
						</td>
					</tr>
