			...
			<div class="col-12 col-lg-6 mb-4">
				<div class="card">
					<div class="card-body">
						...
						<div class="form-group mb-3">
							<div class="d-flex">
								<label for="ads-area-4" class="form-label">{{ __('Ads Area 5') }} </label>
			...
			<div class="col-12 col-lg-6 mb-4">
				<div class="card">
					<div class="card-body">
						...
						<div class="form-group mb-3">
							<div class="d-flex">
								<label for="ads_sidebar_top" class="form-label">{{ __('Ads Sidebar Top') }} </label>
			...
			<div class="col-12 col-lg-6 mb-4">
				<div class="card">
					<div class="card-body">
						...
						<div class="form-group mb-3">
							<div class="d-flex">
								<label for="ads_sidebar_middle" class="form-label">{{ __('Ads Sidebar Middle') }} </label>
			...
			<div class="col-12 col-lg-6 mb-4">
				<div class="card">
					<div class="card-body">
						...
						<div class="form-group mb-3">
							<div class="d-flex">
								<label for="ads_sidebar_bottom" class="form-label">{{ __('Ads Sidebar Bottom') }} </label>
			...
			<div class="col-12 mt-4">
				<div class="card">
					<div class="card-header bg-info text-white">
						<h3 class="card-title">{{ __('Enable or Disable Ads on the specified page') }}</h3>
					</div>
					<div class="card-body">
